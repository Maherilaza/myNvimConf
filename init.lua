...
require('toggleterm').setup{
  ...
  direction = 'horizontal',  -- Orientation par défaut du terminal
  persist_size = true,  -- Conserver la taille du terminal entre les ouvertures
  shade_terminals = true,  -- Appliquer une ombre aux terminaux
  shading_factor = 2,  -- Intensité de l'ombre
  start_in_insert = true,  -- Démarrer en mode insertion
  insert_mappings = true,  -- Activer les raccourcis en mode insertion
  terminal_mappings = true,  -- Activer les raccourcis en mode terminal
  float_opts = {
    border = 'single',  -- Bordure du terminal flottant
    width = 80,  -- Largeur du terminal flottant
    height = 20,  -- Hauteur du terminal flottant
    winblend = 3,  -- Transparence de la fenêtre flottante
    -- Centrer le terminal flottant
    row = math.floor((vim.o.lines - 20) / 2),  -- Centrer verticalement sur la hauteur de l'écran
    col = math.floor((vim.o.columns - 80) / 2),  -- Centrer horizontalement sur la largeur de l'écran
  },
}


-- Crée un keymap pour ouvrir un terminal flottant avec Space + t
vim.api.nvim_set_keymap('n', '<Space>t', ':ToggleTerm direction=float<CR>', { noremap = true, silent = true })

-- Crée un keymap pour quitter le mode terminal et revenir en mode normal avec <Space> + n
...
-- Auto-repasser en mode Insert quand on entre dans une fenêtre Terminal
